...
npz_file = np.load('noisy_data.npz')
x1 = npz_file['x1']
y1 = npz_file['y1']
...
# add noise to gaussian process
stdev_noise = 0.5
sigma_11_noise = sigma_11 + stdev_noise**2
sigma_11_I = np.linalg.inv(sigma_11_noise)
mu_2 = (sigma_11_I @ sigma_11_noise).T @ y1
